  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <button className={styles.button} onClick={loadRequestProvider}> Connect to provider </button>
      ...
      <p> ⚡️ send sats to jose@getalby.com</p>
        ...
        <a rel="me" href="https://github.com/jsahagun91" title="jsahagun on Github">  <p> next.js lightning app template </p>
